            ...
            <div class="dialog-main">
              <div class="renew-content">
                <div class="renew-item" :class="renewActiveId==item.id?'renew-active':''" v-for="item in renewPageData"
                  ...
                  <div class="item-bottom">{$Detail.currency.prefix}{{item.price.toFixed(2)}}</div>
          ...
          <div class="dialog-main">
            ...
            <div class="ip-main-card" v-if="ipValueData.length > 0">
              ...
              <el-tooltip effect="light" v-else :content="lang.mf_range + ipv4Tip" placement="top-end">
                <el-slider v-model="ipValue" show-input :step="1" :min="ipValueData[0].min_value" class="ip-slider"
                  :max="ipValueData[ipValueData.length - 1].max_value" @change="changeIpNum('ipv4', $event)">
                </el-slider>
              </el-tooltip>
            </div>
            <!-- ipv6 -->
            <template v-if="ipv6ValueData.length > 0 && cloudData.network_type !== 'vpc'">
              ...
              <div class="ip-main-card" v-if="ipv6ValueData.length > 0">
                ...
                <el-tooltip effect="light" v-else :content="lang.mf_range + ipv6Tip" placement="top-end">
                  <el-slider v-model="ipv6Value" show-input :step="1" :min="ipv6ValueData[0].min_value" class="ip-slider"
                    :max="ipv6ValueData[ipv6ValueData.length - 1].max_value" @change="changeIpNum('ipv6', $event)">
                  </el-slider>
                </el-tooltip>
              </div>
            </template>
