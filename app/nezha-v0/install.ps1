...
echo $ipapi
if($region -ne "CN"){
$download = "https://gitee.com/starvm/storage/raw/master/app/nezha-v0/nezha-agent_windows_amd64.zip"
Write-Host "Location:$region,connect directly!" -BackgroundColor DarkRed -ForegroundColor Green
}else{
$download = "https://huan-Starvm.github.io/app/nezha-v0/nezha-agent_windows_amd64.zip"
